...
<div class="container">
	...
	<div>
		...
		<input type="text" name="name" on:change={onLabelChange} bind:value={blockData.name} />
	</div>
	<div>
	...
	<div>
		...
		<input type="text" name="placeholder" bind:value={blockData.properties.placeholder} />
	</div>
	<div>
	...
	<div>
		...
		<input type="textarea" name="content" bind:value={blockData.properties.content} />
	</div>
	<hr />
	<div>
